...
List<String> getTheaterUniqueIdsFromScreeningsAndInDate(List<Screening> screenings, DateTime date)
{
  List<String> theaterUniqueIds = [];
  for(Screening tempScreening in screenings)
  {
    if(!theaterUniqueIds.contains(tempScreening.theaterId) && tempScreening.startTime.day == date.day)
    {
...
{
  CollectionReference theatersCollection = FirebaseFirestore.instance.collection("Theater");
